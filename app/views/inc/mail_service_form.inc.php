<form action="/order/checkout" class="order_form" method="post" id="mail_service">
    <input type="hidden" class="user_id" name="user_id" value="<?= \app\services\Session::get('user_id') ?>"/>
    <input type="hidden" class="delivery_type" name="delivery_type" value="2"/>
    <div class="row area checkout_area mail_service_box" style="display: none;">
        <div class="col-sm-6">
                ...
                <div class="new_user_address">
                    ...
                    <div class="checkbox">
                        <label>
                            ...
                            Запомнить адрес для следующих заказов
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="chose_area" style="padding: 30px 20px; margin-bottom: 20px;">
                <div class="form-group">
                    ...
                    <?= app\helpers\Generator::getDeliveryDate() ?>
                </div>
                <div class="form-group">
            ...
            <div class="total_area">
                ...
                <input type="button" class="btn btn-default check_out confirm_btn" data-form="#mail_service" style="margin: 0 auto; display: block;" value="Подтвердить заказ">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="confirm_order" style="display: none">
                ...
                <div class="form-group">
                    <input type="button" class="btn btn-default form-control reorder" data-form="#mail_service" style="margin: 0 auto; display: block;" value="Отредактировать заказ">
                </div>
            </div>
        </div>
    </div>
