        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-aqua">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?=$widgets['products']?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?=$widgets['persentsProds']?>%"></div>
                    </div>
                    <span class="progress-description">
                        Новых товаров в текущем месяце: <?=$widgets['productsPerMonts']?>
                    </span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-green">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?=$widgets['orders']?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?=$widgets['persentsOrders']?>%"></div>
                    </div>
                    <span class="progress-description">
                        Новых заказов в текущем месяце: <?=$widgets['ordersPerMonth']?>
                    </span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </div><!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-yellow">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?=$widgets['clients']?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?=$widgets['persentsClients']?>%"></div>
                    </div>
                    <span class="progress-description">
                        Новых клиентов в текущем месяце: <?=$widgets['clientsPerMonth']?>
                    </span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </div><!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box bg-red">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?=$widgets['comments']?></span>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?=$widgets['persentsComm']?>%"></div>
                    </div>
                    <span class="progress-description">
                        Новых комментариев в текущем месяце: <?=$widgets['commentsPerMonth']?>
                    </span>
                </div><!-- /.info-box-content -->
            </div><!-- /.info-box -->
        </div><!-- /.col -->
