        ...
        <div class="col-md-3">
                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            <b>Цена (руб.)</b> <a class="pull-right"><b><?=$product['price']?></b></a>
                        </li>
                        <li class="list-group-item">
                            <b>Количество</b> <a class="pull-right"><?=$product['quantity']?></a>
                        </li>
                    </ul>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            <b>Опубликован</b> <a class="pull-right"><?= ($product['published'] == 1) ? 'Да' : 'Нет' ?></a>
                        </li>
                        <li class="list-group-item">
                            <b>Дата публикации</b> <a class="pull-right"><?= Helper::dateConverter($product['created_time'])?></a>
                        </li>
                        <li class="list-group-item">
                            <b>Дата обновления</b> <a class="pull-right"><?= Helper::dateConverter($product['updated_time']) ?></a>
                        </li>
                    </ul>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
