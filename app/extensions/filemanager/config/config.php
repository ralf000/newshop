<?php
 ...
 $config = array(
     ...
     /*
       ...
       |
      */
     'upload_dir'       => (isset($_GET['upload_dir']) && !empty($_GET['upload_dir'])) ? '/upload/' . $_GET['upload_dir'] . '/' : '/upload/',
     /*
       |--------------------------------------------------------------------------
       ...
       |
      */
     'current_path'     => (isset($_GET['upload_dir']) && !empty($_GET['upload_dir'])) ? '../../../upload/'.$_GET['upload_dir'].'/' : '../../../upload/',
     /*
       |--------------------------------------------------------------------------
     ...
     /*
       ...
       |
      */
     'access_keys'      => array($_SESSION['generated']),
     //--------------------------------------------------------------------------------------------------------
