function addHandlers() {
    $('.deleteSlide').on('click', function (e) {
        ...
        title = (title && title.length > 0) ? '<br><b>'+ title + '</b>?' : 'этот слайд?';
...
$(function () {
    ...
    $('#showNumSlides select').on('change', function () {
    ...
    $('#showNumSlides select option').each(function () {
